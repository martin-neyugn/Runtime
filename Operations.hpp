...
struct insert_at_back_of_sll
{
  ...
  void operator()( const SomeObject & object )
  {
    ...
    my_sll.insert_after( predecessor, object );
    /////////////////////// END-TO-DO (3) ////////////////////////////
  }
...
struct insert_at_front_of_sll
{
  ...
  void operator()( const SomeObject & object )
  {
    ...
    my_sll.insert_after( my_sll.before_begin(), object );
    /////////////////////// END-TO-DO (6) ////////////////////////////
  }
...
struct search_within_bst
{
  ...
  SomeObject * operator()( const auto & )
  {
    ...
    /// object immediately upon finding it, or a null pointer when you know the object is not in the container.
    auto bstSearch = my_bst.find( target_key );
    if( bstSearch == my_bst.end() )
    {
      return nullptr;
    }
    return &( bstSearch->second );
    /////////////////////// END-TO-DO (20) ////////////////////////////
  }
...
struct search_within_hash_table
{
  ...
  SomeObject * operator()( const auto & )
  {
    ...
    auto mhtSearch = my_hash_table.find( target_key );
    if( mhtSearch == my_hash_table.end() )
    {
      return nullptr;
    }
    return &( mhtSearch->second );
    /////////////////////// END-TO-DO (21) ////////////////////////////
  }
